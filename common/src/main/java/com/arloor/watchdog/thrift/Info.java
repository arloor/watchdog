...
public class Info implements org.apache.thrift.TBase<Info, Info._Fields>, java.io.Serializable, Cloneable, Comparable<Info> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<Target> targets; // required
  ...
  public Info(Info other) {
    if (other.isSetTargets()) {
      java.util.List<Target> __this__targets = new java.util.ArrayList<Target>(other.targets.size());
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<Target> getTargetsIterator() {
    return (this.targets == null) ? null : this.targets.iterator();
  }

  public void addToTargets(Target elem) {
    if (this.targets == null) {
      this.targets = new java.util.ArrayList<Target>();
    }
  ...
  public Info setTargets(@org.apache.thrift.annotation.Nullable java.util.List<Target> targets) {
    this.targets = targets;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TARGETS:
      if (value == null) {
        ...
        setTargets((java.util.List<Target>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.targets = new java.util.ArrayList<Target>(_list0.size);
                @org.apache.thrift.annotation.Nullable Target _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Info struct) throws org.apache.thrift.TException {
      ...
      if (struct.targets != null) {
        oprot.writeFieldBegin(TARGETS_FIELD_DESC);
        {
          ...
          for (Target _iter3 : struct.targets)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetTargets()) {
        {
          ...
          for (Target _iter4 : struct.targets)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.targets = new java.util.ArrayList<Target>(_list5.size);
          @org.apache.thrift.annotation.Nullable Target _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new Target();
            _elem6.read(iprot);
            struct.targets.add(_elem6);
          }
        }
        struct.setTargetsIsSet(true);
      }
